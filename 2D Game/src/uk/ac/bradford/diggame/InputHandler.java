 ...
 * moles for the various keystrokes that are handled.
 *
 * @author prtrundl
 */
public class InputHandler implements KeyListener {
     ...
     * that will have methods called to change player and ghost positions etc.
     *
    ...
    public void keyPressed(KeyEvent e) {
        switch (e.getKeyCode()) {
            case KeyEvent.VK_LEFT -> engine.movePlayer('W');
            //handle left arrow key
            case KeyEvent.VK_RIGHT -> engine.movePlayer('E');
            //handle right arrow
            case KeyEvent.VK_UP -> engine.movePlayer('N');
            //handle up arrow
            case KeyEvent.VK_DOWN -> engine.movePlayer('S');
            //handle down arrow
        }
